...
public class LinkedMachineRecipesBuilder extends AbstractContainer {
    ...
    public LinkedMachineRecipesBuilder(@NotNull SlimefunItemStack item) {
        super(item);
    }
        ...
        return new BlockMenuPreset(getId(), getItemName()) {
            ...
            public void newInstance(@NotNull BlockMenu menu, @NotNull Block b) {
                ...
                menu.addMenuClickHandler(matrix.getChar("G"), (p, s, i, a) -> {
                    ...
                    var recipes = ItemUtil.isLinkedMachineRecipes(menu, matrix, "I");
